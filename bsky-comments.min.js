...
// bsky-comments.js
var BskyComments = class extends r4 {
  static properties = {
    url: {},
  ...
  render() {
    let content = x`<p>loading…</p>`;
    if (this.error) content = x`<p>${this.error}</p>`;
    else if (this.data?.thread) {
      content = x`<bsky-post .post=${this.data.thread}></bsky-post>`;
...
var BskyPost = class extends r4 {
  ...
  render() {
    ...
    return x`<div class="post">
      ...
      <div class="replies">
        ${replies.map((r5) => x`<bsky-post .post=${r5}></bsky-post>`)}
      </div>
    </div>`;
  }
};
...
lit-html/is-server.js:
   ...
   *)
*/
//# sourceMappingURL=bsky-comments.min.js.map
